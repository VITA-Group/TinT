...
def build_non_iso_adjs(args_out, adj_mx, locs):
    ...
    adjNN = torch.tensor(adj_mx).to_sparse().indices()
    _args.edge_index = adjNN
    ...
    _args.N_nodes = len(locs)
    edge_list = assign_multi_kernel(locs, **_args.to_dict())
